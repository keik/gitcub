...
export default class HeaderWithSession extends Component {
  static propTypes = {
  }
          ...
          <nav className={styles.headerNavRight}>
            <ul className={styles.otherClassName}>
              ...
              <li className={dropdownStyles.dropdown}>
                <a
                  onClick={(e) => {e.preventDefault(); this._addModal.open()}}
                  href="#"
                >
              ...
              <li className={dropdownStyles.dropdown}>
                <a
                  onClick={(e) => {e.preventDefault(); this._profileModal.open()}}
                  href="#"
                >
                  <img alt={loginUser} style={{verticalAlign: 'top', width: 20, height: 20, backgroundColor: '#ccc'}}/>  <i className="fa fa-caret-down" />
                </a>
                <Modal
                  width={180}
                  ref={c => this._profileModal = c}
                >
                    <nav className={dropdownStyles.container}>
                      <ul>
