...
test('<RepoFileContent /> with plain-text file should render content as plain text', (t) => {
  ...
  t.is(wrapper.find('#content').html(), '<code class="hljs" id="content">function a() {}</code>')
})
test('<RepoFileContent /> with JavaScript file should render content as JavaScript code', (t) => {
  ...
  const wrapper = shallow(<RepoFileContent {...props} />)
  t.is(wrapper.find('#content').html(), '<code class="hljs" id="content"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">a</span>(<span class="hljs-params"></span>) </span>{}</code>')
})
