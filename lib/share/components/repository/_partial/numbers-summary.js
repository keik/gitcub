...
export default class NumbersSummary extends React.Component {
  static propTypes = {
    branches: PropTypes.array.isRequired,
    commits: PropTypes.array.isRequired,
    contributorsCount: PropTypes.any,
      ...
      <ul className={styles.container}>
        ...
        <li>
          <Link to={`/${owner}/${repo}/branches`}>
            ...
            <span className={styles.emphasized}>{branches.length}</span>{' '}
            branches
          </Link>
        </li>
        <li>
