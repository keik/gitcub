      ...
      <div className={styles.container}>
        <div className="container">
          <nav className={styles.reponav}>
            <ul onClick={this.handleClickNavigation}>
              <li><a href="">Code</a></li>
              <li><a href="issues">Issues {issuesCount}</a></li>
              <li><a href="pulls">Pull requests {pullRequestsCount}</a></li>
              <li><a href="projects">Projects {projectsCount}</a></li>
