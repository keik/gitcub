...
export default class Entries extends Component {
  ...
  render = () => {
    d(`render`)
    const { params: { branch=this.props.defaultBranch, owner, repo, splat: basePath='' }, branches, commits, entries, tags } = this.props
    return (
      <div
        ...
        <div
          ...
          <a
            className={btnStyles.defaultSmBtn}
            href={`${owner}/${repo}/pull/new/${branch}`}>
            New pull request
          </a>
          <div
          ...
          <div className={styles.floatRight}>
            <div className={btnStyles.group}>
              ...
              <a
                className={btnStyles.defaultSmBtn}
                href={`${owner}/${repo}/upload/${branch}`}>
                Upload files
              </a>
              <a
                className={btnStyles.defaultSmBtn}
                href={`${owner}/${repo}/find/${branch}`}>
                Find file
              </a>
            </div>
          </div>
                    ...
                    return (
                      <tr key={path}>
                        ...
                        <td className={styles.name}>
                          <Link to={`/${owner}/${repo}/${type}/${branch}/${basePath ? basePath + '/' : ''}${path}`}>
                            {path}
                          </Link>
                        </td>
