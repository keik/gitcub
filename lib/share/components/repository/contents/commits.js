...
export default class Commits extends Component {
  ...
  render = () => {
    d('render', this.props)
    const { params: { repo, user }, commits } = this.props
    return (
             ...
             <li
               ...
               <div className={styles.main}>
                 ...
                 <div className={styles.meta}>
                   commit.author commited on <time-ago datetime={commit.date} />
                 </div>
               </div>
