...
import type { Commit, File, Parent } from '../../../types/nodegit'
...
export default class RepoCommit extends React.Component<{
  ...
  render() {
    d('render')
    const {
      commit: { author: { date, name }, message },
        ...
        <div>
          ...
          <div>
            <div className={btnStyles.group}>
              <button className={btnStyles.defaultSmBtn}>Unified</button>
              <button className={btnStyles.defaultSmBtn}>Split</button>
            </div>
          </div>
        </div>
