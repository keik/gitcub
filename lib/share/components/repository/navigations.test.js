...
test('<RepoNavigations /> should render active menu according to current route without session', (t) => {
  ...
  t.deepEqual(
    shallow(<RepoNavigations {...props} routes={[{path: ''}]} />)
      .find('Link')
      .map((el) => el.props().to),
    [ '/foo/bar', '/foo/bar/issues', '/foo/bar/pulls', '/foo/bar/projects', '/foo/bar/pulse', '/foo/bar/graphs' ]
  )
...
test('<RepoNavigations /> should render active menu according to current route with session', (t) => {
  const props = {params: {owner: 'foo', repo: 'bar'}, session: {}}
  ...
  t.deepEqual(
    shallow(<RepoNavigations {...props} routes={[{path: ''}]} />)
      .find('Link')
      .map((el) => el.props().to),
    [ '/foo/bar', '/foo/bar/issues', '/foo/bar/pulls', '/foo/bar/projects', '/foo/bar/wiki', '/foo/bar/pulse', '/foo/bar/graphs', '/foo/bar/settings' ]
  )
