        ...
        >
          ...
          <div className={styles.repoNamesControl}>
            <div className={formStyles.formGroup}>
              ...
              <input className={formStyles.formControl}  id="owner" name="owner" type="text" />
            </div>
            <span> / </span>
            <div className={formStyles.formGroup}>
              <label htmlFor="name">Repository name</label>
              <input className={formStyles.formControl} id="name" name="name" type="text" />
            </div>
          </div>

          <div className={formStyles.formGroup}>
            <label htmlFor="description">Description (optional)</label>
            <input className={`${formStyles.formControl} ${formStyles.full}`}  id="description" name="description" type="text" />
          </div>
