...
import type { RepositoryParamsT } from '../../client/main'
...
export const Repository = ({
  ...
  issuesCount: number,
  location: *,
  match: { params: RepositoryParamsT },
...
export const Navigations: React.StatelessFunctionalComponent<Props> = styled(
  ({
    className,
    issuesCount,
    location,
