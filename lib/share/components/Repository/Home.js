...
import type { RepositoryTreeParamsT } from '../../../client/main'
import type {
  BranchObj,
  CommitObj,
  ParentObj,
...
type Props = {
  ...
  match: { params: RepositoryTreeParamsT },
  tags: $PropertyType<ReducersStateT, 'tags'>
}
export const Home: React.StatelessFunctionalComponent<Props> = styled(
  (
    props: Props & {
      className: string
    }
...
const NumbersSummary: React.StatelessFunctionalComponent<
  NumbersSummaryProps
> = styled(
  ({
    branches,
