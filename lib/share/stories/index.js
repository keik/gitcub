...
[
  [Modal, [
    ['with single child', {active: true, children: <div>div 1</div>}],
    ['with multiple children', {active: true, children: [<div key="1">div 1</div>, <div key="2">div 2</div>]}]
  ]],
  [Header, [
  ...
  [RepositoryContentsEntries, [
    ['with dummy props', {branches: ['BRANCH_1', 'BRANCH_2'],
