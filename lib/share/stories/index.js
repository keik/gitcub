// breaking now. waiting storybook v4
    ...
    [
      [
        'with single child',
        {
          children: [
            <TabItems key="1">
              <TabItem key="t1" target="t1" active>
                t1
              </TabItem>
              <TabItem key="t2" target="t2">
                t2
              </TabItem>
              <TabItem key="t3" target="t3">
                t3
              </TabItem>
            </TabItems>,
            <TabPanel key="2" ref={c => (this.t1 = c)}>
              t1 panel
            </TabPanel>,
            <TabPanel key="3" ref={c => (this.t2 = c)}>
              t2 panel
            </TabPanel>,
            <TabPanel key="4" ref={c => (this.t3 = c)}>
              t3 panel
            </TabPanel>
          ]
        }
          ...
          entries: [
            {
              ...
              path: 'FILE_1',
              lastCommit: {
                id: '8412d2f5d42781b181e97922ea7e5159ad142f15',
            ...
            },
            {
              ...
              path: 'FILE_2',
              lastCommit: {
                id: 'ad87fd3a5b305c55343c545ac58c275e82a7c840',
            ...
            },
            {
              ...
              path: 'FILE_3',
              lastCommit: {
                id: 'a278d85850790f3f696a4ed82a69fa5062033b08',
