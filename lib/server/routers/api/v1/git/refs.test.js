...
let PORT
test.test('setup', t => {
  app = new Express().use(refsRouter).listen(0)
...
test(`GET ${API_GIT_REFS} with no param should return list of all refs`, t => {
  axios
    ...
    .then(res => {
      ...
      t.deepEqual(
        res.data.sort((a, b) => a.ref > b.ref),
        [
          {
            ref: 'refs/heads/feature',
            url:
              'http://localhost:3000/api/v1/repos/user1/repo1/git/refs/heads/feature',
            object: {
              type: 'commit',
          ...
          },
          {
            ...
            url:
              'http://localhost:3000/api/v1/repos/user1/repo1/git/refs/heads/master',
            object: {
              type: 'commit',
          ...
          },
          {
            ...
            url:
              'http://localhost:3000/api/v1/repos/user1/repo1/git/refs/tags/v1.0.0',
            object: {
              type: 'tag',
              sha: '9e20f2d7bdcc5027cc0a8083f07f32e1a0d1f34d',
              url:
                'http://localhost:3000/api/v1/repos/user1/repo1/git/tags/9e20f2d7bdcc5027cc0a8083f07f32e1a0d1f34d'
            }
          }
