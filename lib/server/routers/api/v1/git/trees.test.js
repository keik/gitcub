...
test(`GET ${API_GIT_TREES} with no parameter should return name of entries in default branch`, (t) => {
  axios.get(`http://localhost:${PORT}/api/v1/repos/user1/repo1/git/trees`)
    .then((res) => {
...
test(`GET ${API_GIT_TREES} with SHA should return name of entries`, (t) => {
  axios.get(`http://localhost:${PORT}/api/v1/repos/user1/repo1/git/trees/297862f2168af863ae0e2735caabe8b7461f188f`)
    .then((res) => {
      res.data.tree.sort((a, b) => a.path > b.path)
      // console.log(require('util').inspect(res.data, false, null))
      t.deepEqual(res.data,
        { url: 'http://localhost:3000/api/v1/repos/user1/repo1/git/trees/297862f2168af863ae0e2735caabe8b7461f188f',
...
test(`GET ${API_GIT_TREES} with REFERENCE should return name of entries`, (t) => {
  axios.get(`http://localhost:${PORT}/api/v1/repos/user1/repo1/git/trees/feature`)
    .then((res) => {
      res.data.tree.sort((a, b) => a.path > b.path)
      // console.log(require('util').inspect(res.data, false, null))
      t.deepEqual(res.data,
...
test(`GET ${API_GIT_TREES} with REFERENCE?last_commit should return name of entries with last_commit`, (t) => {
  axios.get(`http://localhost:${PORT}/api/v1/repos/user1/repo1/git/trees/297862f2168af863ae0e2735caabe8b7461f188f?last_commit=1`)
    .then((res) => {
      // console.log(require('util').inspect(res.data, false, null))
      res.data.tree.sort((a, b) => a.path > b.path)
...
test(`GET ${API_GIT_TREES} from no exists repo should return 404`, (t) => {
  axios.get(`http://localhost:${PORT}/api/v1/repos/no_exists_user/foo/git/trees`)
    .then((res) => {
      t.fail(res)
    })
    .catch((err) => {
