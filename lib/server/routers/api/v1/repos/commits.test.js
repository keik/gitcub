...
let PORT
test.test('setup', t => {
  app = new Express().use(commitsRouter).listen(0)
  ...
  axios
    ...
    .then(res => {
      ...
      t.deepEqual(res.data[0], {
        ...
        html_url:
          'http://localhost:3000/user1/repo1/commit/0100c14d9341db683c43e47c6944ecb1616005bd',
        parents: [
          {
            url:
              'http://localhost:3000/api/v1/repos/user1/repo1/commits/f1582566910f7a5d41b47f0c93ed560e1e1fd8d0',
            sha: 'f1582566910f7a5d41b47f0c93ed560e1e1fd8d0'
          }
        ],
        sha: '0100c14d9341db683c43e47c6944ecb1616005bd',
        url:
          'http://localhost:3000/api/v1/repos/user1/repo1/commits/0100c14d9341db683c43e47c6944ecb1616005bd'
      })
    })
    .catch(err => {
      t.fail(err.toString())
      ...
      t.deepEqual(res.data[0], {
        commit: {
          ...
          parents: [
            {
              url:
                'http://localhost:3000/api/v1/repos/user1/repo1/git/commits/297862f2168af863ae0e2735caabe8b7461f188f',
          ...
          tree: {
            url:
              'http://localhost:3000/api/v1/repos/user1/repo1/git/trees/ec03c563e29b0f50af9e561ad19f9df24dfe7e10',
            sha: 'ec03c563e29b0f50af9e561ad19f9df24dfe7e10'
          },
          url:
            'http://localhost:3000/api/v1/repos/user1/repo1/git/commits/2394f21336aec34a5a225f1e8b9039593f1d1e27'
        },
        html_url:
          'http://localhost:3000/user1/repo1/commit/2394f21336aec34a5a225f1e8b9039593f1d1e27',
        parents: [
          {
            url:
              'http://localhost:3000/api/v1/repos/user1/repo1/commits/297862f2168af863ae0e2735caabe8b7461f188f',
            sha: '297862f2168af863ae0e2735caabe8b7461f188f'
          }
        ],
        sha: '2394f21336aec34a5a225f1e8b9039593f1d1e27',
        url:
          'http://localhost:3000/api/v1/repos/user1/repo1/commits/2394f21336aec34a5a225f1e8b9039593f1d1e27'
      })
    })
    .catch(err => {
      t.fail(err.toString())
      ...
      t.deepEqual(res.data, {
        commit: {
          ...
          parents: [
            {
              url:
                'http://localhost:3000/api/v1/repos/user1/repo1/git/commits/9e20f2d7bdcc5027cc0a8083f07f32e1a0d1f34d',
          ...
          tree: {
            url:
              'http://localhost:3000/api/v1/repos/user1/repo1/git/trees/dde07dc1ebe9119f0abfb6c64c7813e64e9ff723',
        ...
        html_url:
          'http://localhost:3000/user1/repo1/commit/f1582566910f7a5d41b47f0c93ed560e1e1fd8d0',
        parents: [
          {
            url:
              'http://localhost:3000/api/v1/repos/user1/repo1/commits/9e20f2d7bdcc5027cc0a8083f07f32e1a0d1f34d',
            sha: '9e20f2d7bdcc5027cc0a8083f07f32e1a0d1f34d'
          }
        ],
        sha: 'f1582566910f7a5d41b47f0c93ed560e1e1fd8d0',
        ...
        files: [
          {
            ...
            changes: 3,
            blob_url:
              'http://localhost:3000/user1/repo1}/blob/f1582566910f7a5d41b47f0c93ed560e1e1fd8d0/codes/file.js',
            raw_url:
              'http://localhost:3000/user1/repo1/raw/f1582566910f7a5d41b47f0c93ed560e1e1fd8d0/codes/file.js',
            contents_url:
              'http://localhost:3000/repos/user1/repo1/contents/codes/file.js}?ref=:sha',
            patch:
          ...
          },
          {
            ...
            changes: 11,
            blob_url:
              'http://localhost:3000/user1/repo1}/blob/f1582566910f7a5d41b47f0c93ed560e1e1fd8d0/codes/file.md',
            raw_url:
              'http://localhost:3000/user1/repo1/raw/f1582566910f7a5d41b47f0c93ed560e1e1fd8d0/codes/file.md',
            contents_url:
              'http://localhost:3000/repos/user1/repo1/contents/codes/file.md}?ref=:sha',
            patch:
          ...
          },
          {
            ...
            changes: 1,
            blob_url:
              'http://localhost:3000/user1/repo1}/blob/f1582566910f7a5d41b47f0c93ed560e1e1fd8d0/codes/file.rb',
            raw_url:
              'http://localhost:3000/user1/repo1/raw/f1582566910f7a5d41b47f0c93ed560e1e1fd8d0/codes/file.rb',
            contents_url:
              'http://localhost:3000/repos/user1/repo1/contents/codes/file.rb}?ref=:sha',
            patch: "@@ -0,0 +1 @@\n+puts 'Hello Ruby'"
          }
        ],
