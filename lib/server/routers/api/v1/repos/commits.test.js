...
test.cb(`GET ${API_REPOS_COMMITS} with no param should return commits in default branch`, (t) => {
  axios.get(`http://localhost:${PORT}/api/v1/repos/user1/repo1/commits`)
    .then((res) => {
...
test.cb(`GET ${API_REPOS_COMMITS}/sha=SHA should return commits from specified SHA`, (t) => {
  axios.get(`http://localhost:${PORT}/api/v1/repos/user1/repo1/commits?sha=2394f21336aec34a5a225f1e8b9039593f1d1e27`)
    .then((res) => {
      // console.log(require('util').inspect(res.data[0], false, null))
...
test.cb(`GET ${API_REPOS_COMMITS}/sha=REF should return commits from specified SHA`, (t) => {
  axios.get(`http://localhost:${PORT}/api/v1/repos/user1/repo1/commits?sha=feature`)
    .then((res) => {
      // console.log(require('util').inspect(res.data[0], false, null))
      t.is(res.data.length, 5)
      t.deepEqual(res.data[0],
...
test.cb(`GET ${API_REPOS_COMMITS} with SHA should return a specified commit`, (t) => {
  axios.get(`http://localhost:${PORT}/api/v1/repos/user1/repo1/commits/f1582566910f7a5d41b47f0c93ed560e1e1fd8d0`)
    .then((res) => {
      ...
      t.deepEqual(res.data,
        { commit:
          ...
          [ { sha: 'deb8561a16afdee514523b1f3ea6bd32d3287fa2',
            ...
            contents_url: 'http://localhost:3000/repos/user1/repo1/contents/codes/file.js}?ref=:sha',
            ...
            { sha: '7b5e06f87463a1c164155523151fd3f90b585049',
              ...
              contents_url: 'http://localhost:3000/repos/user1/repo1/contents/codes/file.md}?ref=:sha',
            ...
            { sha: 'b97038f29f6d581aa86d6417f9ed464c1cdfeba2',
              ...
              contents_url: 'http://localhost:3000/repos/user1/repo1/contents/codes/file.rb}?ref=:sha',
              patch: '@@ -0,0 +1 @@\n+puts \'Hello Ruby\'' } ],
...
test.cb(`GET ${API_REPOS_COMMITS} from no exists repo should return 404`, (t) => {
  axios.get(`http://localhost:${PORT}/api/v1/repos/no_exists_user/foo/commits`)
    .then((res) => {
      t.fail(res)
    })
    .catch((err) => {
