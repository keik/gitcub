...
let PORT
test.test('setup', t => {
  app = new Express().use(branchesRouter).listen(0)
...
test(`GET ${API_REPOS_BRANCHES} with no param should return branches in default branch`, t => {
  axios
    ...
    .then(res => {
      ...
      t.deepEqual(
        res.data.sort((a, b) => a.commit.author.date > b.commit.author.date),
        [
          {
            name: 'feature',
            commit: {
              ...
              parents: [
                {
                  url:
                    'http://localhost:3000/api/v1/repos/undefined/undefined/git/commits/297862f2168af863ae0e2735caabe8b7461f188f',
              ...
              tree: {
                url:
                  'http://localhost:3000/api/v1/repos/undefined/undefined/git/trees/ec03c563e29b0f50af9e561ad19f9df24dfe7e10',
                sha: 'ec03c563e29b0f50af9e561ad19f9df24dfe7e10'
              },
              url:
                'http://localhost:3000/api/v1/repos/undefined/undefined/git/commits/2394f21336aec34a5a225f1e8b9039593f1d1e27'
            }
          },
          {
            name: 'master',
            commit: {
              ...
              parents: [
                {
                  url:
                    'http://localhost:3000/api/v1/repos/undefined/undefined/git/commits/f1582566910f7a5d41b47f0c93ed560e1e1fd8d0',
              ...
              tree: {
                url:
                  'http://localhost:3000/api/v1/repos/undefined/undefined/git/trees/dfd076cc884b4554bab928f62123fb262c02ec6c',
                sha: 'dfd076cc884b4554bab928f62123fb262c02ec6c'
              },
              url:
                'http://localhost:3000/api/v1/repos/undefined/undefined/git/commits/0100c14d9341db683c43e47c6944ecb1616005bd'
            }
          }
