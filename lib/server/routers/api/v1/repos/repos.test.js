...
test(`POST ${API_REPOS.LOGIN_USERS} should return 201 when specified name repository does not exist`, (t) => {
...
test(`POST ${API_REPOS.LOGIN_USERS} should return 409 when specified name repository already exists`, (t) => {
...
test(`GET ${API_REPOS.PUBLIC} should return list of all public repositories`, (t) => {
...
test(`GET ${API_REPOS.USERS} should return list of all specified user\'s' repositories`, (t) => {
...
test(`GET ${API_REPOS.USERS} from users which have no repository should return empty list`, (t) => {
