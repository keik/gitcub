...
import { API_GIT_COMMITS, API_GIT_TREES, API_REPOS_COMMITS } from '../../../../share/constants/api'

export function convertCommitToReposCommitObject(commit, owner, repo, withStats) {
  return {
...
export function convertCommitToGitCommitObject(commit, owner, repo) {
