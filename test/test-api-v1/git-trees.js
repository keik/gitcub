...
import { API_GIT_TREES } from '../../lib/share/constants/api'
          ...
          { url: '/api/v1/repos/user1/repo1/git/trees/297862f2168af863ae0e2735caabe8b7461f188f?last_commit=1',
            ...
            [ { path: 'd/file3',
              ...
              { author:
                ...
                message: 'Add d/file3\n',
                parents:
                [ { url: 'http://localhost:3000/api/v1/repos/repo1/user1/git/commits/3c27dc60c76be4a1f5b765cb141d0d22d871a2b6',
                  sha: '3c27dc60c76be4a1f5b765cb141d0d22d871a2b6' } ],
                sha: 'e801527fecc2efb3a2e710a21a226ca0abf9db63',
                tree:
                { url: 'http://localhost:3000/api/v1/repos/repo1/user1/git/trees/20bd2419ce4536e4e62700550d23ba7c3233eed9',
                  sha: '20bd2419ce4536e4e62700550d23ba7c3233eed9' },
                url: 'http://localhost:3000/api/v1/repos/repo1/user1/git/commits/e801527fecc2efb3a2e710a21a226ca0abf9db63' } },
              { path: 'file1',
                type: 'blob',
                sha: 'ce013625030ba8dba906f756967f9e9ca394464a',
                lastCommit:
                { author:
                  ...
                  tree:
                  { url: 'http://localhost:3000/api/v1/repos/repo1/user1/git/trees/d001d287018593691c36042e1c8089fde7415296',
                    sha: 'd001d287018593691c36042e1c8089fde7415296' },
                  url: 'http://localhost:3000/api/v1/repos/repo1/user1/git/commits/d29e783434a7fadfa5bbf7b361dfc20a83ad8722' } },
              { path: 'file2',
                type: 'blob',
                sha: 'cc628ccd10742baea8241c5924df992b5c019f71',
                lastCommit:
                { author:
                  ...
                  sha: '3c27dc60c76be4a1f5b765cb141d0d22d871a2b6',
                  tree:
                  { url: 'http://localhost:3000/api/v1/repos/repo1/user1/git/trees/812bcf7a7db574cf24a2d6b8ed92cfd096c219e5',
              ...
              { path: 'file3',
                ...
                { author:
                  ...
                  sha: '297862f2168af863ae0e2735caabe8b7461f188f',
                  tree:
                  { url: 'http://localhost:3000/api/v1/repos/repo1/user1/git/trees/6be2dafb160ab380d886f5a9a488843653f4aaa3',
                    sha: '6be2dafb160ab380d886f5a9a488843653f4aaa3' },
                  url: 'http://localhost:3000/api/v1/repos/repo1/user1/git/commits/297862f2168af863ae0e2735caabe8b7461f188f' } } ] }
          )
      }).catch((err) => {
        t.fail(err.toString())
      }).finally(t.end)
